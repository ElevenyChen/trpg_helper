...
def check_result(character):
    ...
    if dice_result == critical:
        result = "大成功"
    elif dice_result <= extreme:
        result = "极难成功"
    ...
    # Check for fumble based on the skill value
    if skill_value >= 50 and dice_result == 100 or skill_value < 50 and 96 <= dice_result <= 100:
        result = "大失败"
